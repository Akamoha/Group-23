...
public class DBM
{
	...
	{
		DBM db = new DBM("Students");
		
		//String keys[] = {"ID","NAME","PASSWORD","EMAIL","MESS","EATEN"};
		//String values[] = {"2013A7PS696G","Dharm Skandh Jain","pass696","f2013696@goa.bits-pilani.ac.in","C","1"};
		
		//db.insertData("STUDENTS", keys, values);
		
		ResultSet rs = db.selectData("SELECT * FROM STUDENTS");
